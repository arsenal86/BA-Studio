  ...
  useEffect(() => {
        const updateOutput = async () => {
            if (briefing && outputRef.current) {
                const parsed = await marked.parse(briefing);
    ...
    <div className="animate-fade-in max-w-5xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-lg text-slate-600 dark:text-slate-400">
          Your AI-powered weekly intelligence briefing on BA trends, tools, and
          techniques.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 min-h-[60vh] flex flex-col">
        {error && (
          <div
            className="bg-red-100 dark:bg-red-900 border-l-4 border-red-500 text-red-700 dark:text-red-200 p-4 rounded-md mb-4"
            role="alert"
          >
          ...
          {!isLoading && !briefing && !error && (
            <div className="flex flex-col items-center justify-center h-full text-center p-8">
              <div className="w-16 h-16 flex items-center justify-center bg-primary-100 dark:bg-slate-900 rounded-full mb-6">
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3h2m-4 3H9m-4 6h6m-6 4h6m4-11h2m-2 4h2m-2 4h2M9 3v2m6 13V9"
                  />
                </svg>
              </div>
              ...
              <p className="text-slate-500 dark:text-slate-400 max-w-xl mb-6">
                Click the button to get the latest intelligence on industry
                trends, new tools, deep-dive techniques, case study insights,
                and UK community news.
              </p>
              <button
