    ...
    <div className="flex justify-center mb-6">
      <div className="relative flex w-full max-w-sm p-1 bg-slate-200 dark:bg-slate-700 rounded-full">
        <span
          ...
          style={{
            transform:
              mode === "agenda" ? "translateX(0%)" : "translateX(100%)",
          }}
        ></span>
        <button
    ...
    <div className="flex flex-col h-full animate-fade-in">
      <div className="mb-6 text-center">
        ...
        <p className="mt-2 text-lg text-slate-600 dark:text-slate-400">
          Streamline your meeting prep and follow-up with AI.
        </p>
      </div>
          ...
          {mode === "agenda" ? (
            <div className="space-y-4">
              <input
                ...
                placeholder="Meeting Topic (e.g., Q3 Project Kick-off)"
                className="w-full p-3 bg-slate-50 dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:outline-none"
              />
              <textarea
                value={objectives}
                onChange={(e) => setObjectives(e.target.value)}
                placeholder="Key Objectives (one per line)..."
                rows={4}
                className="w-full p-3 bg-slate-50 dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg resize-y focus:ring-2 focus:ring-primary-500 focus:outline-none"
              ></textarea>
              <input
                type="text"
                value={attendees}
