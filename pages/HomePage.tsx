    ...
    return (
        <div className="animate-fade-in">
            <div className="text-center mb-12">
                <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 dark:text-white">Welcome to <span className="bg-gradient-to-r from-indigo-600 to-emerald-400 dark:from-indigo-300 dark:to-emerald-200 bg-clip-text text-transparent">BA Studio</span></h1>
